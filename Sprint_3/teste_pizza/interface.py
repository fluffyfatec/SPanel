...
list_tabela=['SÃO PAULO', 'GUARULHOS', 'CAMPINAS', 'SÃO BERNARDO DO CAMPO', 'SÃO JOSÉ DOS CAMPOS', 'SANTO ANDRÉ', 'RIBEIRÃO PRETO',
                    'OSASCO', 'SOROCABA', 'MAUÁ']
             #df_tratado[df_tratado['nome_munic']== 'SÃO PAULO'] and df_tratado[df_tratado['nome_munic']== 'GUARULHOS']
...
# ==================================================================
    ...
    , dbc.Row([
        dbc.Col([
            dcc.Markdown(['''>
    > Tabela
    >'''], className="lb_tabela", style={'margin-top': '40px', 'margin-left': '10px'})
        ])
    ])
    , dbc.Row([
        dbc.Col([
            html.Div([
                ...
                dt.DataTable(
                    id='table',
                    data=df_tratado.to_dict('records'),
                    columns=[{"name": i, "id": i} for i in sorted(df_tratado.columns)],
                    style_cell=dict(textAlign='left',style={"color": "#00000","font-weight": "bold","padding-top":"10px",
                    'minWidth': 95, 'width': 95, 'maxWidth': 95,'height': 300}),
                    editable=True,
                    sort_action="native",
                    sort_mode="single",
                    ...
                    page_current=0,
                    page_size=10,
                    style_table={'height': '300px', 'overflowY': 'auto',"font-weight": "bold","color": "#00000"},
