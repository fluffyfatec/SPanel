...
df_tratado_rename.to_csv('teste.csv')
                    ...
                    dbc.CardBody([
                         dcc.Dropdown(
                            ...
                            dt.DataTable(
                                ...
                                style_cell={'minWidth': '95px', 'width': '180px', 'maxWidth': '180px','whiteSpace': 'auto','height': 'auto'},
                                editable=False,
                                sort_action="native",
                                sort_mode="single",
                                row_deletable=False,
...
##E68B8B
                                        ...
                                        [
                                            {
                                                'if': {
                                                    'filter_query': '{{Casos Acumulados}} = {}'.format(df_tratado_rename['Casos Acumulados'].max()),
                                        ...
                                        [
                                            {
                                                'if': {
                                                    'filter_query': '{{Óbitos Acumulados}} = {}'.format(df_tratado_rename['Óbitos Acumulados'].max()),
                                        ...
                                        [
                                            {
                                                'if': {
                                                    'filter_query': '{{Dose Unica}} = {}'.format(df_tratado_rename['Dose Unica'].max()),
                                        ...
                                        [
                                            {
                                                'if': {
                                                    'filter_query': '{{Primeira Dose}} = {}'.format(df_tratado_rename['Primeira Dose'].max()),
                                        ...
                                        [
                                            {
                                                'if': {
                                                    'filter_query': '{{Segunda Dose}} = {}'.format(df_tratado_rename['Segunda Dose'].max()),
                                        ...
                                        [
                                            {
                                                'if': {
                                                    'filter_query': '{{Terceira Dose}} = {}'.format(df_tratado_rename['Terceira Dose'].max()),
                                        ...
                                        [
                                            {
                                                'if': {
                                                    'filter_query': '{{População}} = {}'.format(df_tratado_rename['População'].max()),
                                                        'column_id': 'População',
                                                        },
                                                        'backgroundColor': '#E68B8B',
                                                    'color': 'white'}
